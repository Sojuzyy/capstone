...
if ($_SERVER["REQUEST_METHOD"] == "GET") {
    ...
    if ($userId != null) {
        // You can use the $userId variable to fetch data from your database
        // Example: Assume you have a function getStudentInfoById($userId) to get student info
        ...
        if ($userId != null) {
            ...
            echo "Middle Name: " . $studentInfo['middlename'] . "<br>";
            echo "Contact Number: " . $studentInfo['contactnum'] . "<br>";
            echo "Branch: " . $studentInfo['branch'] . "<br>";
            echo "Strand: " . $studentInfo['strand'] . "<br>";
            echo "Gender: " . $studentInfo['gender'] . "<br>";
            echo "Year: " . $studentInfo['year'] . "<br>";
            echo "Section: " . $studentInfo['section'] . "<br>";
        } else {
...
// Example function to get student info from the database
function getStudentInfoById($userId) {
    // Replace this with your database query to fetch student info based on the user ID
    // Example: SELECT * FROM students WHERE user_id = $userId
...
<body>
<form id="your-form-id" action="admin-submitcreatedstudentaccount.php" method="get">

        <div class="row">
            <div class="col">
                <div class="mb-3">
                    <label for="user-firstname" class="form-label">First Name</label>
                    <input data="<?php echo $firstname; ?>" type="text" name="firstname" id="user-firstname" class="form-control" placeholder="Enter First Name" autocomplete="off" required>
